...
mixin _$CameraStore on _CameraStore, Store {
  late final _$cameraControllerAtom = Atom(
    name: '_CameraStore.cameraController',
    context: context,
  );
  ...
  late final _$_camerasDescriptionAtom = Atom(
    name: '_CameraStore._camerasDescription',
    context: context,
  );
  ...
  late final _$selectedCameraDescriptionAtom = Atom(
    name: '_CameraStore.selectedCameraDescription',
    context: context,
  );
  ...
  late final _$isCameraInitializedAtom = Atom(
    name: '_CameraStore.isCameraInitialized',
    context: context,
  );
  ...
  late final _$isToggleCameraAtom = Atom(
    name: '_CameraStore.isToggleCamera',
    context: context,
  );
  ...
  late final _$_isAllowInitCameraResumedAtom = Atom(
    name: '_CameraStore._isAllowInitCameraResumed',
    context: context,
  );
  ...
  late final _$imageGalleryAtom = Atom(
    name: '_CameraStore.imageGallery',
    context: context,
  );
  ...
  late final _$getCameraDescriptionAsyncAction = AsyncAction(
    '_CameraStore.getCameraDescription',
    context: context,
  );
  ...
  late final _$onNewCameraSelectedAsyncAction = AsyncAction(
    '_CameraStore.onNewCameraSelected',
    context: context,
  );
  ...
  late final _$_initializeCameraControllerAsyncAction = AsyncAction(
    '_CameraStore._initializeCameraController',
    context: context,
  );
  ...
  late final _$_setCameraDescriptionAsyncAction = AsyncAction(
    '_CameraStore._setCameraDescription',
    context: context,
  );
  ...
  late final _$_CameraStoreActionController = ActionController(
    name: '_CameraStore',
    context: context,
  );
  ...
  void disposeCameraController() {
    final _$actionInfo = _$_CameraStoreActionController.startAction(
      name: '_CameraStore.disposeCameraController',
    );
    try {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    final _$actionInfo = _$_CameraStoreActionController.startAction(
      name: '_CameraStore.didChangeAppLifecycleState',
    );
    try {
  ...
  CameraDescription _getTypeOfCameraDescription({
    ...
    final _$actionInfo = _$_CameraStoreActionController.startAction(
      name: '_CameraStore._getTypeOfCameraDescription',
    );
    try {
