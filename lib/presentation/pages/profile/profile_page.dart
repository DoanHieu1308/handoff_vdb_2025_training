...
class ProfilePage extends StatelessWidget {
  late ProfileStore store = AppInit.instance.profileStore;
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  buildInfoProfile(),
                  buildFriendProfile(context),
                  SizedBox(height: 10.h),
                  buildFeeling(),
                  SizedBox(height: 10.h),
                  // PostStatus(homeStore: store),
              ...
              child: SizedBox(
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      "Bộ lọc",
                      style: AppText.text14.copyWith(color: Colors.indigoAccent),
                    ),
                  ],
                ),
              ),
  ...
  Widget buildFriendProfile(BuildContext context) {
    return Observer(
      builder: (context) {
        return Column(
          children: [
  ...
  Widget buildLeadProfile(BuildContext context) {
    return Observer(
      builder: (context) {
        return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(left: 15.w),
              child: Text(store.userProfile.name ?? "", style: AppText.text25_bold),
            ),
            Padding(
              padding: EdgeInsets.only(left: 15.w),
              child: Row(
  ...
  Positioned _buildAvata(BuildContext context) {
    return Positioned(
      left: 10.w,
      top: 80.h,
      child: Observer(
          ...
          return Stack(
            children: [
              ...
              Positioned(
                ...
                child: GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushNamed(AuthRouters.CAMERA);
                  },
                  child: CircleAvatar(
                    radius: 20,
