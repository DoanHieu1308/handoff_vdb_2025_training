...
mixin _$FriendsStore on _FriendsStore, Store {
  late final _$selectedCategoryNameAtom =
      Atom(name: '_FriendsStore.selectedCategoryName', context: context);
  ...
  set selectedCategoryName(String value) {
    _$selectedCategoryNameAtom.reportWrite(value, super.selectedCategoryName,
        () {
  ...
  late final _$friendListAtom =
      Atom(name: '_FriendsStore.friendList', context: context);
  ...
  late final _$friendListPendingAtom =
      Atom(name: '_FriendsStore.friendListPending', context: context);
  ...
  late final _$friendListSuggestionAtom =
      Atom(name: '_FriendsStore.friendListSuggestion', context: context);
  ...
  set friendListSuggestion(ObservableList<UserModel> value) {
    _$friendListSuggestionAtom.reportWrite(value, super.friendListSuggestion,
        () {
      super.friendListSuggestion = value;
    });
  }

  late final _$friendListSuggestionStatusAtom =
      Atom(name: '_FriendsStore.friendListSuggestionStatus', context: context);
  ...
  set friendListSuggestionStatus(ObservableList<Map<String, dynamic>> value) {
    _$friendListSuggestionStatusAtom
        .reportWrite(value, super.friendListSuggestionStatus, () {
      super.friendListSuggestionStatus = value;
    });
  }

  late final _$friendListSentAtom =
      Atom(name: '_FriendsStore.friendListSent', context: context);
  ...
  late final _$friendListSearchAtom =
      Atom(name: '_FriendsStore.friendListSearch', context: context);
  ...
  late final _$acceptFriendAtom =
      Atom(name: '_FriendsStore.acceptFriend', context: context);
  ...
  late final _$rejectFriendAtom =
      Atom(name: '_FriendsStore.rejectFriend', context: context);
  ...
  late final _$getDataFriendAsyncAction =
      AsyncAction('_FriendsStore.getDataFriend', context: context);
  ...
  late final _$handleAcceptFriendRequestAsyncAction =
      AsyncAction('_FriendsStore.handleAcceptFriendRequest', context: context);

  @override
  Future<void> handleAcceptFriendRequest({required String friendId}) {
    return _$handleAcceptFriendRequestAsyncAction
        .run(() => super.handleAcceptFriendRequest(friendId: friendId));
  }

  late final _$handleRejectFriendRequestAsyncAction =
      AsyncAction('_FriendsStore.handleRejectFriendRequest', context: context);
  ...
  Future<void> handleRejectFriendRequest(
    ...
    return _$handleRejectFriendRequestAsyncAction.run(() => super
  ...
  late final _$handleSentFriendRequestAsyncAction =
      AsyncAction('_FriendsStore.handleSentFriendRequest', context: context);

  @override
  Future<void> handleSentFriendRequest(
      {required String friendId, required dynamic Function() onSuccess}) {
    return _$handleSentFriendRequestAsyncAction.run(() => super
        .handleSentFriendRequest(friendId: friendId, onSuccess: onSuccess));
  }

  late final _$handleCancelFriendRequestAsyncAction =
      AsyncAction('_FriendsStore.handleCancelFriendRequest', context: context);

  @override
  Future<void> handleCancelFriendRequest(
      {required String friendId, required dynamic Function() onSuccess}) {
    return _$handleCancelFriendRequestAsyncAction.run(() => super
        .handleCancelFriendRequest(friendId: friendId, onSuccess: onSuccess));
  }

  late final _$goToInfoFriendAsyncAction =
      AsyncAction('_FriendsStore.goToInfoFriend', context: context);

  @override
  Future<void> goToInfoFriend(
      {required String friendId, required BuildContext context}) {
    return _$goToInfoFriendAsyncAction
        .run(() => super.goToInfoFriend(friendId: friendId, context: context));
  }

  late final _$checkLoginStatusAsyncAction =
      AsyncAction('_FriendsStore.checkLoginStatus', context: context);
