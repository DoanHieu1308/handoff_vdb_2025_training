...
mixin SizeUtil {
  ...
  /// Get max size width.
  ///
  static double getMaxWidth() => ScreenUtil().screenWidth;

  ///
  /// Get max size height.
  ///
  static double getMaxHeight() => ScreenUtil().screenHeight;

  ///
  /// Set size for Size Box, Container.
  ///
  static double setSize({required double percent}) => percent.sh;

  ///
  /// Set size with height.
  ///
  static double setSizeWithWidth({required double percent}) => percent.sw;
  ...
  /// Set EdgeInsets all.
  ///
  static REdgeInsets setEdgeInsetsAll(double value) => REdgeInsets.all(value);

  ///
  /// Set EdgeInsets only.
  ///
  static REdgeInsets setEdgeInsetsOnly({double? bottom = 0, double? right = 0, double? left = 0, double? top = 0}) => REdgeInsets.only(
    bottom: bottom!,
    right: right!,
    left: left!,
    top: top!,
  ...
  ///
  static REdgeInsets setEdgeInsetsSymmetric({double vertical = 0, double horizontal = 0}) => REdgeInsets.symmetric(
    vertical: vertical,
  ...
  /// Set radius circular.
  ///
  static Radius setRadiusCircular({required double radius}) => Radius.circular(radius).w;

  ///
  /// Set border radius all.
  ///
  static BorderRadius setBorderRadiusAll({required double radius}) => BorderRadius.all(Radius.circular(radius)).w;
  ...
  static double PADDING_BOTTOM = 20.h;
