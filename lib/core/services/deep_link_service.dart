    ...
    switch (socialType) {
      ...
      case 'chat':
        ...
        if (pathSegments.length > 1) {
          // TODO: Cần implement cách lấy UserModel từ userId
          // _router.push(AuthRoutes.CHAT, extra: userModel);
          if (kDebugMode) {
            print("⚠️ DeepLinkService: Chat route requires UserModel implementation for userId: ${pathSegments[1]}");
          }
        } else {
